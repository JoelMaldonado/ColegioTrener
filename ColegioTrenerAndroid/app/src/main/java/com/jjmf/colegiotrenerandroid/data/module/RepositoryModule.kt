...
import com.jjmf.colegiotrenerandroid.data.repository.CarnetRepositoryImp
...
import com.jjmf.colegiotrenerandroid.data.repository.JustificacionRepositoryImp
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun carnetRepo(impl: CarnetRepositoryImp): CarnetRepository

    @Binds
    abstract fun justificacionRepo(impl: JustificacionRepositoryImp): JustificacionRepository
